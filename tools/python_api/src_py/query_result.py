...
class QueryResult:
    ...
    def __init__(self, connection: _monad.Connection, query_result: _monad.QueryResult):  # type: ignore[name-defined]
        """
        Parameters
        ----------
        connection : _monad.Connection
            The underlying C++ connection object from pybind11.

        query_result : _monad.QueryResult
