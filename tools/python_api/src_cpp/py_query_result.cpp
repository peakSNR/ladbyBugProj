...
py::object PyQueryResult::convertValueToPyObject(const Value& value) {
    ...
    case LogicalTypeID::INT128: {
        monad::common::int128_t result = value.getValue<monad::common::int128_t>();
        std::string int128_string = monad::common::Int128_t::toString(result);
    ...
    case LogicalTypeID::UUID: {
        monad::common::int128_t result = value.getValue<monad::common::int128_t>();
        std::string uuidString = monad::common::UUID::toString(result);
...
monad::pyarrow::Table PyQueryResult::getAsArrow(std::int64_t chunkSize,
    bool fallbackExtensionTypes) {
    ...
    return py::cast<monad::pyarrow::Table>(fromBatchesFunc(batches, schemaObj));
}
