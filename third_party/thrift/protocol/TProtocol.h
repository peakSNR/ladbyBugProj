...
#ifndef _MONAD_THRIFT_PROTOCOL_TPROTOCOL_H_
#define _MONAD_THRIFT_PROTOCOL_TPROTOCOL_H_ 1
...
namespace monad_apache { namespace thrift {
...
#endif // #define _MONAD_THRIFT_PROTOCOL_TPROTOCOL_H_ 1
