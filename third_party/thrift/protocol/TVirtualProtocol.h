...
#ifndef _MONAD_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_
#define _MONAD_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_ 1
...
using monad_apache::thrift::transport::TTransport;
...
public:
  ...
  uint32_t skip(TType type) { return ::monad_apache::thrift::protocol::skip(*this, type); }
...
public:
  ...
  uint32_t skip(TType type) {
    ...
    return ::monad_apache::thrift::protocol::skip(*prot, type);
  }
...
#endif // #define _MONAD_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_ 1
