...
#ifndef _MONAD_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_
#define _MONAD_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_ 1
 ...
 *
 */
class TProtocolException : public monad_apache::thrift::TException {
public:
  /**
  ...
  TProtocolException() : monad_apache::thrift::TException(), type_(UNKNOWN) {}

  TProtocolException(TProtocolExceptionType type) : monad_apache::thrift::TException(), type_(type) {}
...
} // monad_apache::thrift::protocol

#endif // #ifndef _MONAD_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_
