...
#ifndef _MONAD_THRIFT_TRANSPORT_TTRANSPORTEXCEPTION_H_
#define _MONAD_THRIFT_TRANSPORT_TTRANSPORTEXCEPTION_H_ 1

#include <string>
#include "Thrift.h"

namespace monad_apache {
namespace thrift {
namespace transport {
 ...
 *
 */
class TTransportException : public monad_apache::thrift::TException {
public:
  /**
  ...
  TTransportException() : monad_apache::thrift::TException(), type_(UNKNOWN) {}

  TTransportException(TTransportExceptionType type) : monad_apache::thrift::TException(), type_(type) {}

  TTransportException(const std::string& message)
    : monad_apache::thrift::TException(message), type_(UNKNOWN) {}

  TTransportException(TTransportExceptionType type, const std::string& message)
    : monad_apache::thrift::TException(message), type_(type) {}
...
} // monad_apache::thrift::transport

#endif // #ifndef _MONAD_THRIFT_TRANSPORT_TTRANSPORTEXCEPTION_H_
