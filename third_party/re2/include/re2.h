...
private:
    ...
    monad::regex::Regexp* entire_regexp_; // parsed regular expression
    monad::regex::Regexp* suffix_regexp_; // parsed regular expression, prefix_ removed
...
using monad::regex::LazyRE2;
using monad::regex::RE2;
