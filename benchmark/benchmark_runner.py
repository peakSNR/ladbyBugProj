...
monad_benchmark_tool = os.path.join(
    base_dir, '..', 'build', 'release', 'tools', 'benchmark', 'monad_benchmark')
...
if __name__ == '__main__':
    ...
    is_success = run_monad(serialized_graph_path)
