...
--
-- Name: monad; Type: SCHEMA; Schema: -; Owner: ci
--

CREATE SCHEMA monad;


ALTER SCHEMA monad OWNER TO ci;
...
--
-- Name: user; Type: TABLE; Schema: monad; Owner: ci
--

CREATE TABLE monad."user" (
    id integer,
...
ALTER TABLE monad."user" OWNER TO ci;
...
--
-- Data for Name: user; Type: TABLE DATA; Schema: monad; Owner: ci
--

COPY monad."user" (id, org, rate) FROM stdin;
5	apple	4
7	ms	5
9	blackberry	7
\.
