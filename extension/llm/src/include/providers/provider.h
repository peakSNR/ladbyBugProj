...
public:
    ...
    static constexpr const char* referenceMonadDocs =
        "For more information, please refer to the official Monad documentation: "
        "https://docs.monaddb.com/extensions/llm/\n";
