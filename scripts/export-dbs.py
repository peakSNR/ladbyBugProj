...
# Example scripts/export-dbs.py build/debug/tools/shell/monad dataset.
def main():
    parser = argparse.ArgumentParser(
        description="Export DBs with MONAD shell and dataset paths"
    )

    parser.add_argument(
        "--executable", required=True, help="Path to the MONAD shell executable"
    )
    parser.add_argument(
