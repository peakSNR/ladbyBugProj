...
def _get_monad_version():
    cmake_file = os.path.join(base_dir, 'monad-source', 'CMakeLists.txt')
...
monad_version = _get_monad_version()
print("The version of this build is %s" % monad_version)
...
class CMakeBuild(build_ext):
    def build_extension(self, ext: CMakeExtension) -> None:
        ...
        build_dir = os.path.join(ext.sourcedir, 'monad-source')
