PYPI_URL = "https://pypi.org/pypi/monad/json"
TEST_PYPI_URL = "https://test.pypi.org/pypi/monad/json"
CMAKE_KEYWORD = "project(Monad VERSION "
CMAKE_SUFFIX = " LANGUAGES CXX C)\n"
EXTENSION_KEYWORD = 'add_definitions(-DMONAD_EXTENSION_VERSION="'
EXTENSION_SUFFIX = '")\n'
...
def main():
    ...
    sys.stdout.flush()
    os.system("git config user.email ci@avra.ai")
    os.system("git config user.name \"Monad CI\"")
