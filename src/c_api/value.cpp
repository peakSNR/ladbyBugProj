...
monad_value* monad_value_create_null() {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(Value::createNullValue());
    return c_value;
}

monad_value* monad_value_create_null_with_data_type(monad_logical_type* data_type) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value =
...
bool monad_value_is_null(monad_value* value) {
    return static_cast<Value*>(value->_value)->isNull();
}

void monad_value_set_null(monad_value* value, bool is_null) {
    static_cast<Value*>(value->_value)->setNull(is_null);
}

monad_value* monad_value_create_default(monad_logical_type* data_type) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value =
...
monad_value* monad_value_create_bool(bool val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(val_);
    return c_value;
}

monad_value* monad_value_create_int8(int8_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(val_);
    return c_value;
}

monad_value* monad_value_create_int16(int16_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(val_);
    return c_value;
}

monad_value* monad_value_create_int32(int32_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(val_);
    return c_value;
}

monad_value* monad_value_create_int64(int64_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(val_);
    return c_value;
}

monad_value* monad_value_create_uint8(uint8_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(val_);
    return c_value;
}

monad_value* monad_value_create_uint16(uint16_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(val_);
    return c_value;
}

monad_value* monad_value_create_uint32(uint32_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(val_);
    return c_value;
}

monad_value* monad_value_create_uint64(uint64_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(val_);
    return c_value;
}

monad_value* monad_value_create_int128(monad_int128_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
...
monad_value* monad_value_create_float(float val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(val_);
    return c_value;
}

monad_value* monad_value_create_double(double val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(val_);
    return c_value;
}

monad_value* monad_value_create_internal_id(monad_internal_id_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
...
monad_value* monad_value_create_date(monad_date_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
...
monad_value* monad_value_create_timestamp_ns(monad_timestamp_ns_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
...
monad_value* monad_value_create_timestamp_ms(monad_timestamp_ms_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
...
monad_value* monad_value_create_timestamp_sec(monad_timestamp_sec_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
...
monad_value* monad_value_create_timestamp_tz(monad_timestamp_tz_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
...
monad_value* monad_value_create_timestamp(monad_timestamp_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
...
monad_value* monad_value_create_interval(monad_interval_t val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
...
monad_value* monad_value_create_string(const char* val_) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(val_);
    return c_value;
}

monad_state monad_value_create_list(uint64_t num_elements, monad_value** elements,
...
monad_state monad_value_create_struct(uint64_t num_fields, const char** field_names,
...
monad_state monad_value_create_map(uint64_t num_fields, monad_value** keys, monad_value** values,
    monad_value** out_value) {
    if (num_fields == 0) {
        return MonadError;
    }
...
monad_value* monad_value_clone(monad_value* value) {
    auto* c_value = (monad_value*)calloc(1, sizeof(monad_value));
    c_value->_value = new Value(*static_cast<Value*>(value->_value));
    return c_value;
}

void monad_value_copy(monad_value* value, monad_value* other) {
    static_cast<Value*>(value->_value)->copyValueFrom(*static_cast<Value*>(other->_value));
}

void monad_value_destroy(monad_value* value) {
    if (value == nullptr) {
        return;
    }
...
monad_state monad_value_get_list_size(monad_value* value, uint64_t* out_result) {
...
monad_state monad_value_get_list_element(monad_value* value, uint64_t index, monad_value* out_value) {
...
monad_state monad_value_get_struct_num_fields(monad_value* value, uint64_t* out_result) {
    auto physical_type_id = static_cast<Value*>(value->_value)->getDataType().getPhysicalType();
...
monad_state monad_value_get_struct_field_name(monad_value* value, uint64_t index, char** out_result) {
    auto physical_type_id = static_cast<Value*>(value->_value)->getDataType().getPhysicalType();
    if (physical_type_id != PhysicalTypeID::STRUCT) {
        return MonadError;
    }
...
monad_state monad_value_get_struct_field_value(monad_value* value, uint64_t index,
    monad_value* out_value) {
    return monad_value_get_list_element(value, index, out_value);
}

monad_state monad_value_get_map_size(monad_value* value, uint64_t* out_result) {
...
monad_state monad_value_get_map_key(monad_value* value, uint64_t index, monad_value* out_key) {
    monad_value map_entry;
    if (monad_value_get_list_element(value, index, &map_entry) == MonadError) {
        return MonadError;
    }
    return monad_value_get_struct_field_value(&map_entry, 0, out_key);
}

monad_state monad_value_get_map_value(monad_value* value, uint64_t index, monad_value* out_value) {
    monad_value map_entry;
    if (monad_value_get_list_element(value, index, &map_entry) == MonadError) {
        return MonadError;
    }
    return monad_value_get_struct_field_value(&map_entry, 1, out_value);
}

monad_state monad_value_get_recursive_rel_node_list(monad_value* value, monad_value* out_value) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_recursive_rel_rel_list(monad_value* value, monad_value* out_value) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
    if (logical_type_id != LogicalTypeID::RECURSIVE_REL) {
        return MonadError;
    }
...
void monad_value_get_data_type(monad_value* value, monad_logical_type* out_data_type) {
    out_data_type->_data_type =
        new LogicalType(static_cast<Value*>(value->_value)->getDataType().copy());
}

monad_state monad_value_get_bool(monad_value* value, bool* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_int8(monad_value* value, int8_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_int16(monad_value* value, int16_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_int32(monad_value* value, int32_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_int64(monad_value* value, int64_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_uint8(monad_value* value, uint8_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_uint16(monad_value* value, uint16_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_uint32(monad_value* value, uint32_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_uint64(monad_value* value, uint64_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_int128(monad_value* value, monad_int128_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_int128_t_from_string(const char* str, monad_int128_t* out_result) {
    int128_t int128_val = 0;
    try {
        monad::function::CastString::operation(ku_string_t{str, strlen(str)}, int128_val);
        out_result->low = int128_val.low;
        out_result->high = int128_val.high;
...
monad_state monad_int128_t_to_string(monad_int128_t int128_val, char** out_result) {
    int128_t c_int128 = 0;
...
monad_state monad_value_get_float(monad_value* value, float* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_double(monad_value* value, double* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_internal_id(monad_value* value, monad_internal_id_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_date(monad_value* value, monad_date_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_timestamp(monad_value* value, monad_timestamp_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_timestamp_ns(monad_value* value, monad_timestamp_ns_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_timestamp_ms(monad_value* value, monad_timestamp_ms_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_timestamp_sec(monad_value* value, monad_timestamp_sec_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_timestamp_tz(monad_value* value, monad_timestamp_tz_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_decimal_as_string(monad_value* value, char** out_result) {
...
monad_state monad_value_get_interval(monad_value* value, monad_interval_t* out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_string(monad_value* value, char** out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_blob(monad_value* value, uint8_t** out_result, uint64_t* out_length) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
monad_state monad_value_get_uuid(monad_value* value, char** out_result) {
    auto logical_type_id = static_cast<Value*>(value->_value)->getDataType().getLogicalTypeID();
...
char* monad_value_to_string(monad_value* value) {
    return convertToOwnedCString(static_cast<Value*>(value->_value)->toString());
}

monad_state monad_node_val_get_id_val(monad_value* node_val, monad_value* out_value) {
...
monad_state monad_node_val_get_label_val(monad_value* node_val, monad_value* out_value) {
    auto logical_type_id = static_cast<Value*>(node_val->_value)->getDataType().getLogicalTypeID();
    if (logical_type_id != LogicalTypeID::NODE) {
        return MonadError;
    }
...
monad_state monad_node_val_get_property_size(monad_value* node_val, uint64_t* out_result) {
    auto logical_type_id = static_cast<Value*>(node_val->_value)->getDataType().getLogicalTypeID();
    if (logical_type_id != LogicalTypeID::NODE) {
        return MonadError;
    }
...
monad_state monad_node_val_get_property_name_at(monad_value* node_val, uint64_t index,
    char** out_result) {
    auto logical_type_id = static_cast<Value*>(node_val->_value)->getDataType().getLogicalTypeID();
    if (logical_type_id != LogicalTypeID::NODE) {
        return MonadError;
...
monad_state monad_node_val_get_property_value_at(monad_value* node_val, uint64_t index,
    monad_value* out_value) {
    auto logical_type_id = static_cast<Value*>(node_val->_value)->getDataType().getLogicalTypeID();
    if (logical_type_id != LogicalTypeID::NODE) {
        return MonadError;
...
monad_state monad_node_val_to_string(monad_value* node_val, char** out_result) {
    auto logical_type_id = static_cast<Value*>(node_val->_value)->getDataType().getLogicalTypeID();
    if (logical_type_id != LogicalTypeID::NODE) {
        return MonadError;
    }
...
monad_state monad_rel_val_get_id_val(monad_value* rel_val, monad_value* out_value) {
...
monad_state monad_rel_val_get_src_id_val(monad_value* rel_val, monad_value* out_value) {
    auto logical_type_id = static_cast<Value*>(rel_val->_value)->getDataType().getLogicalTypeID();
    if (logical_type_id != LogicalTypeID::REL) {
        return MonadError;
    }
...
monad_state monad_rel_val_get_dst_id_val(monad_value* rel_val, monad_value* out_value) {
    auto logical_type_id = static_cast<Value*>(rel_val->_value)->getDataType().getLogicalTypeID();
    if (logical_type_id != LogicalTypeID::REL) {
        return MonadError;
    }
...
monad_state monad_rel_val_get_label_val(monad_value* rel_val, monad_value* out_value) {
    auto logical_type_id = static_cast<Value*>(rel_val->_value)->getDataType().getLogicalTypeID();
    if (logical_type_id != LogicalTypeID::REL) {
        return MonadError;
    }
...
monad_state monad_rel_val_get_property_size(monad_value* rel_val, uint64_t* out_result) {
    auto logical_type_id = static_cast<Value*>(rel_val->_value)->getDataType().getLogicalTypeID();
    if (logical_type_id != LogicalTypeID::REL) {
        return MonadError;
    }
...
monad_state monad_rel_val_get_property_name_at(monad_value* rel_val, uint64_t index,
    char** out_result) {
    auto logical_type_id = static_cast<Value*>(rel_val->_value)->getDataType().getLogicalTypeID();
    if (logical_type_id != LogicalTypeID::REL) {
        return MonadError;
...
monad_state monad_rel_val_get_property_value_at(monad_value* rel_val, uint64_t index,
    monad_value* out_value) {
    auto logical_type_id = static_cast<Value*>(rel_val->_value)->getDataType().getLogicalTypeID();
    if (logical_type_id != LogicalTypeID::REL) {
        return MonadError;
...
monad_state monad_rel_val_to_string(monad_value* rel_val, char** out_result) {
    auto logical_type_id = static_cast<Value*>(rel_val->_value)->getDataType().getLogicalTypeID();
    if (logical_type_id != LogicalTypeID::REL) {
        return MonadError;
    }
...
void monad_destroy_string(char* str) {
    free(str);
}

void monad_destroy_blob(uint8_t* blob) {
    free(blob);
}

monad_state monad_timestamp_ns_to_tm(monad_timestamp_ns_t timestamp, struct tm* out_result) {
...
monad_state monad_timestamp_ms_to_tm(monad_timestamp_ms_t timestamp, struct tm* out_result) {
...
monad_state monad_timestamp_sec_to_tm(monad_timestamp_sec_t timestamp, struct tm* out_result) {
...
monad_state monad_timestamp_tz_to_tm(monad_timestamp_tz_t timestamp, struct tm* out_result) {
...
monad_state monad_timestamp_to_tm(monad_timestamp_t timestamp, struct tm* out_result) {
    time_t time = timestamp.value / 1000000;
#ifdef _WIN32
    if (convertTimeToTm(time, out_result) != 0) {
        return MonadError;
...
monad_state monad_timestamp_ns_from_tm(struct tm tm, monad_timestamp_ns_t* out_result) {
#ifdef _WIN32
...
monad_state monad_timestamp_ms_from_tm(struct tm tm, monad_timestamp_ms_t* out_result) {
#ifdef _WIN32
    int64_t time = convertTmToTime(tm);
#else
    int64_t time = timegm(&tm);
...
monad_state monad_timestamp_sec_from_tm(struct tm tm, monad_timestamp_sec_t* out_result) {
#ifdef _WIN32
    int64_t time = convertTmToTime(tm);
#else
    int64_t time = timegm(&tm);
...
monad_state monad_timestamp_tz_from_tm(struct tm tm, monad_timestamp_tz_t* out_result) {
#ifdef _WIN32
    int64_t time = convertTmToTime(tm);
#else
    int64_t time = timegm(&tm);
...
monad_state monad_timestamp_from_tm(struct tm tm, monad_timestamp_t* out_result) {
#ifdef _WIN32
    int64_t time = convertTmToTime(tm);
#else
    int64_t time = timegm(&tm);
...
monad_state monad_date_to_tm(monad_date_t date, struct tm* out_result) {
...
monad_state monad_date_from_tm(struct tm tm, monad_date_t* out_result) {
#ifdef _WIN32
    int64_t time = convertTmToTime(tm);
#else
    int64_t time = timegm(&tm);
...
monad_state monad_date_to_string(monad_date_t date, char** out_result) {
    tm tm{};
    if (monad_date_to_tm(date, &tm) != MonadSuccess) {
        return MonadError;
    }
    char buffer[80];
...
monad_state monad_date_from_string(const char* str, monad_date_t* out_result) {
    try {
...
void monad_interval_to_difftime(monad_interval_t interval, double* out_result) {
...
void monad_interval_from_difftime(double difftime, monad_interval_t* out_result) {
