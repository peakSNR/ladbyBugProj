...
namespace monad::main {
struct DBConfig;
} // namespace monad::main

namespace monad {
namespace main {
class AttachedMonadDatabase;
} // namespace main
...
class MONAD_API Catalog {
    friend class main::AttachedMonadDatabase;
...
public:
    ...
    ScalarMacroCatalogEntry* getScalarMacroCatalogEntry(const transaction::Transaction* transaction,
        monad::common::oid_t MacroID) const;
    void dropMacroEntry(transaction::Transaction* transaction, const monad::common::oid_t macroID);
