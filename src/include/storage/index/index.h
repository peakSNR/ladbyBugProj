...
struct MONAD_API IndexStorageInfo {
    IndexStorageInfo() {}
...
public:
    ...
    void serialize(common::Serializer& ser) const;
    MONAD_API void load(main::ClientContext* context, StorageManager* storageManager);
