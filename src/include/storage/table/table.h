...
struct MONAD_API TableScanState {
    Table* table;
...
struct MONAD_API TableInsertState {
...
struct MONAD_API TableUpdateState {
...
struct MONAD_API TableDeleteState {
    bool logToWAL;
