...
struct MONAD_API NodeTableScanState : TableScanState {
...
struct MONAD_API NodeTableInsertState : TableInsertState {
...
struct MONAD_API NodeTableUpdateState : TableUpdateState {
    common::ValueVector& nodeIDVector;
...
struct MONAD_API NodeTableDeleteState : TableDeleteState {
    common::ValueVector& nodeIDVector;
...
class MONAD_API NodeTable final : public Table {
public:
