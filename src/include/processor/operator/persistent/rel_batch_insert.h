...
struct MONAD_API RelBatchInsertPrintInfo final : OPPrintInfo {
...
struct MONAD_API RelBatchInsertProgressSharedState {
...
struct MONAD_API RelBatchInsertInfo final : BatchInsertInfo {
 ...
 */
class MONAD_API RelBatchInsertImpl {
public:
...
class MONAD_API RelBatchInsert : public BatchInsert {
public:
