...
public:
     ...
     */
    MONAD_API common::Value& operator[](common::idx_t idx);
     ...
     */
    MONAD_API const common::Value& operator[](common::idx_t idx) const;
     ...
     */
    MONAD_API std::string toString(const std::vector<uint32_t>& colsWidth,
