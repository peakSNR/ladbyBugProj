...
MONAD_API uint128_t operator+(const uint128_t& lhs, const uint128_t& rhs);
MONAD_API uint128_t operator-(const uint128_t& lhs, const uint128_t& rhs);
MONAD_API uint128_t operator*(const uint128_t& lhs, const uint128_t& rhs);
MONAD_API uint128_t operator/(const uint128_t& lhs, const uint128_t& rhs);
MONAD_API uint128_t operator%(const uint128_t& lhs, const uint128_t& rhs);
MONAD_API uint128_t operator^(const uint128_t& lhs, const uint128_t& rhs);
MONAD_API uint128_t operator&(const uint128_t& lhs, const uint128_t& rhs);
MONAD_API uint128_t operator~(const uint128_t& val);
MONAD_API uint128_t operator|(const uint128_t& lhs, const uint128_t& rhs);
MONAD_API uint128_t operator<<(const uint128_t& lhs, int amount);
MONAD_API uint128_t operator>>(const uint128_t& lhs, int amount);

// comparison operators
MONAD_API bool operator==(const uint128_t& lhs, const uint128_t& rhs);
MONAD_API bool operator!=(const uint128_t& lhs, const uint128_t& rhs);
MONAD_API bool operator>(const uint128_t& lhs, const uint128_t& rhs);
MONAD_API bool operator>=(const uint128_t& lhs, const uint128_t& rhs);
MONAD_API bool operator<(const uint128_t& lhs, const uint128_t& rhs);
...
template<>
struct std::hash<monad::common::uint128_t> {
    std::size_t operator()(const monad::common::uint128_t& v) const noexcept;
};
