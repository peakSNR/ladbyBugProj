...
public:
     ...
     */
    MONAD_API static Value createNullValue();
    /**
     * @param dataType the type of the NULL value.
     * @return a NULL value of the given type.
     */
    MONAD_API static Value createNullValue(const LogicalType& dataType);
    /**
     * @param dataType the type of the non-NULL value.
     * @return a default non-NULL value of the given type.
     */
    MONAD_API static Value createDefaultValue(const LogicalType& dataType);
    /**
     * @param val_ the boolean value to set.
     */
    MONAD_API explicit Value(bool val_);
    /**
     * @param val_ the int8_t value to set.
     */
    MONAD_API explicit Value(int8_t val_);
    /**
     * @param val_ the int16_t value to set.
     */
    MONAD_API explicit Value(int16_t val_);
    /**
     * @param val_ the int32_t value to set.
     */
    MONAD_API explicit Value(int32_t val_);
    /**
     * @param val_ the int64_t value to set.
     */
    MONAD_API explicit Value(int64_t val_);
    /**
     * @param val_ the uint8_t value to set.
     */
    MONAD_API explicit Value(uint8_t val_);
    /**
     * @param val_ the uint16_t value to set.
     */
    MONAD_API explicit Value(uint16_t val_);
    /**
     * @param val_ the uint32_t value to set.
     */
    MONAD_API explicit Value(uint32_t val_);
    /**
     * @param val_ the uint64_t value to set.
     */
    MONAD_API explicit Value(uint64_t val_);
    /**
     * @param val_ the int128_t value to set.
     */
    MONAD_API explicit Value(int128_t val_);
    /**
     * @param val_ the UUID value to set.
     */
    MONAD_API explicit Value(ku_uuid_t val_);
    /**
     * @param val_ the double value to set.
     */
    MONAD_API explicit Value(double val_);
    /**
     * @param val_ the float value to set.
     */
    MONAD_API explicit Value(float val_);
    /**
     * @param val_ the date value to set.
     */
    MONAD_API explicit Value(date_t val_);
    /**
     * @param val_ the timestamp_ns value to set.
     */
    MONAD_API explicit Value(timestamp_ns_t val_);
    /**
     * @param val_ the timestamp_ms value to set.
     */
    MONAD_API explicit Value(timestamp_ms_t val_);
    /**
     * @param val_ the timestamp_sec value to set.
     */
    MONAD_API explicit Value(timestamp_sec_t val_);
    /**
     * @param val_ the timestamp_tz value to set.
     */
    MONAD_API explicit Value(timestamp_tz_t val_);
    /**
     * @param val_ the timestamp value to set.
     */
    MONAD_API explicit Value(timestamp_t val_);
    /**
     * @param val_ the interval value to set.
     */
    MONAD_API explicit Value(interval_t val_);
    /**
     * @param val_ the internalID value to set.
     */
    MONAD_API explicit Value(internalID_t val_);
    /**
     * @param val_ the uint128_t value to set.
     */
    MONAD_API explicit Value(uint128_t val_);
    /**
     * @param val_ the string value to set.
     */
    MONAD_API explicit Value(const char* val_);
    /**
     * @param val_ the string value to set.
     */
    MONAD_API explicit Value(const std::string& val_);
    /**
     * @param val_ the uint8_t* value to set.
     */
    MONAD_API explicit Value(uint8_t* val_);
     ...
     * @param val_ the string value to set.
     */
    MONAD_API explicit Value(LogicalType type, std::string val_);
    /**
     * @param dataType the logical type of the value.
     * @param children a vector of children values.
     */
    MONAD_API explicit Value(LogicalType dataType, std::vector<std::unique_ptr<Value>> children);
    /**
     * @param other the value to copy from.
     */
    MONAD_API Value(const Value& other);

    /**
     * @param other the value to move from.
     */
    MONAD_API Value(Value&& other) = default;
    MONAD_API Value& operator=(Value&& other) = default;
    MONAD_API bool operator==(const Value& rhs) const;

    /**
     * @brief Sets the data type of the Value.
     * @param dataType_ the data type to set to.
     */
    MONAD_API void setDataType(const LogicalType& dataType_);
    /**
     * @return the dataType of the value.
     */
    MONAD_API const LogicalType& getDataType() const;
    /**
     * @brief Sets the null flag of the Value.
     * @param flag null value flag to set.
     */
    MONAD_API void setNull(bool flag);
    /**
     * @brief Sets the null flag of the Value to true.
     */
    MONAD_API void setNull();
    /**
     * @return whether the Value is null or not.
     */
    MONAD_API bool isNull() const;
    /**
     * @brief Copies from the row layout value.
     * @param value value to copy from.
     */
    MONAD_API void copyFromRowLayout(const uint8_t* value);
    /**
     * @brief Copies from the col layout value.
     * @param value value to copy from.
     */
    MONAD_API void copyFromColLayout(const uint8_t* value, ValueVector* vec = nullptr);
    /**
     * @brief Copies from the other.
     * @param other value to copy from.
     */
    MONAD_API void copyValueFrom(const Value& other);
    /**
     ...
     */
    MONAD_API std::unique_ptr<Value> copy() const;
    /**
     * @return the current value in string format.
     */
    MONAD_API std::string toString() const;

    MONAD_API void serialize(Serializer& serializer) const;

    MONAD_API static std::unique_ptr<Value> deserialize(Deserializer& deserializer);

    MONAD_API void validateType(common::LogicalTypeID targetTypeID) const;
