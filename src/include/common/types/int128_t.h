...
MONAD_API int128_t operator+(const int128_t& lhs, const int128_t& rhs);
MONAD_API int128_t operator-(const int128_t& lhs, const int128_t& rhs);
MONAD_API int128_t operator*(const int128_t& lhs, const int128_t& rhs);
MONAD_API int128_t operator/(const int128_t& lhs, const int128_t& rhs);
MONAD_API int128_t operator%(const int128_t& lhs, const int128_t& rhs);
MONAD_API int128_t operator^(const int128_t& lhs, const int128_t& rhs);
MONAD_API int128_t operator&(const int128_t& lhs, const int128_t& rhs);
MONAD_API int128_t operator~(const int128_t& val);
MONAD_API int128_t operator|(const int128_t& lhs, const int128_t& rhs);
MONAD_API int128_t operator<<(const int128_t& lhs, int amount);
MONAD_API int128_t operator>>(const int128_t& lhs, int amount);

// comparison operators
MONAD_API bool operator==(const int128_t& lhs, const int128_t& rhs);
MONAD_API bool operator!=(const int128_t& lhs, const int128_t& rhs);
MONAD_API bool operator>(const int128_t& lhs, const int128_t& rhs);
MONAD_API bool operator>=(const int128_t& lhs, const int128_t& rhs);
MONAD_API bool operator<(const int128_t& lhs, const int128_t& rhs);
...
template<>
struct std::hash<monad::common::int128_t> {
    std::size_t operator()(const monad::common::int128_t& v) const noexcept;
};
