...
#define KU_ASSERT_UNCONDITIONAL(condition)                                                         \
    static_cast<bool>(condition) ?                                                                 \
        void(0) :                                                                                  \
        monad::common::kuAssertFailureInternal(#condition, __FILE__, __LINE__)

#if defined(MONAD_RUNTIME_CHECKS) || !defined(NDEBUG)
...
#define KU_UNREACHABLE                                                                             \
    /* LCOV_EXCL_START */ [[unlikely]] monad::common::kuAssertFailureInternal("KU_UNREACHABLE",     \
