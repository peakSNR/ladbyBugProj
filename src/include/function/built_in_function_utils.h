...
public:
    ...
    // functions.
    static MONAD_API Function* matchFunction(const std::string& name,
    ...
    static MONAD_API uint32_t getCastCost(common::LogicalTypeID inputTypeID,
        common::LogicalTypeID targetTypeID);

    static MONAD_API std::string getFunctionMatchFailureMsg(const std::string name,
