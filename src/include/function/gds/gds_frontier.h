...
class MONAD_API SparseFrontier : public Frontier {
...
class MONAD_API DenseFrontier : public Frontier {
...
class MONAD_API DenseSparseDynamicFrontierPair : public FrontierPair {
public:
...
class MONAD_API DenseFrontierPair : public FrontierPair {
public:
