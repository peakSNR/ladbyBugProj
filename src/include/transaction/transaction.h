...
class MONAD_API LocalCacheObject {
public:
...
extern MONAD_API Transaction DUMMY_TRANSACTION;
extern MONAD_API Transaction DUMMY_CHECKPOINT_TRANSACTION;
