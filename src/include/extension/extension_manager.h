...
public:
    ...
    MONAD_API const std::vector<LoadedExtension>& getLoadedExtensions() const {
    ...
    MONAD_API static ExtensionManager* Get(const main::ClientContext& context);
