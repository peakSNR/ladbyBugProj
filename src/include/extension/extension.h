...
struct MONAD_API ExtensionUtils {
    static constexpr const char* OFFICIAL_EXTENSION_REPO = "http://extension.monaddb.com/";
    static constexpr const char* EXTENSION_FILE_SUFFIX = "monad_extension";
...
class MONAD_API ExtensionLibLoader {
public:
