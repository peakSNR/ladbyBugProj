...
public:
    ...
    MONAD_API AttachedDatabase* getAttachedDatabase(const std::string& name);
    ...
    MONAD_API void invalidateCache();

    MONAD_API static DatabaseManager* Get(const ClientContext& context);
