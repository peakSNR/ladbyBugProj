...
public:
    ...
    AttachedMonadDatabase* getAttachedDatabase() const;
    ...
    void setDefaultDatabase(AttachedMonadDatabase* defaultDatabase_);
...
private:
    ...
    // Remote database.
    AttachedMonadDatabase* remoteDatabase;
    // Progress bar.
