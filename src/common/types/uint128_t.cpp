...
std::size_t std::hash<monad::common::uint128_t>::operator()(
    const monad::common::uint128_t& v) const noexcept {
    monad::common::hash_t hash = 0;
    monad::function::Hash::operation(v, hash);
    return hash;
}
