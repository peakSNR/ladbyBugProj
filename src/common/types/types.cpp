...
using monad::function::BuiltInFunctionsUtils;
...
bool UDTTypeInfo::operator==(const monad::common::ExtraTypeInfo& other) const {
...
const LogicalType& ListType::getChildType(const monad::common::LogicalType& type) {
...
const LogicalType& StructTypeInfo::getChildType(monad::common::struct_field_idx_t idx) const {
...
bool LogicalTypeUtils::isNested(monad::common::LogicalTypeID logicalTypeID) {
